        ...
        <nav class="bg-black fixed fixed w-full z-20 top-0 left-0 border-b border-gray-700">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">App Citas Barber
                    </span>
                </a>
               ...
               focus:outline-none focus:ring-2 focus:ring-gray-600"
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
                 ...
                 md:flex-row md:space-x-8 md:mt-0 bg-transparent">
                        ...
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-white hover:text-blue-400">Home
                            </a>
                        </li>

                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-white hover:text-blue-400">About
                            </a>
                        </li>

                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-white hover:text-blue-400">Services
                            </a>
                        </li>

                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-white hover:text-blue-400">Contact
                            </a>
                        </li>
